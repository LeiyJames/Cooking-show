...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="light">
      ...
      <body
        className={`${inter.className} bg-gradient-to-br from-cooking-50 to-warm-50 dark:from-gray-900 dark:to-gray-800 min-h-screen transition-colors duration-300`}
      >
