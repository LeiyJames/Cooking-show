    ...
    >
      ...
      <AnimatePresence>
        {showSwipeIndicator && swipeDirection && (
          ...
          >
            <div
              className={`p-4 rounded-full bg-cooking-500/20 backdrop-blur-sm ${
                swipeDirection === "left"
                  ? "ml-4"
                  : swipeDirection === "right"
                    ? "mr-4"
            ...
            >
              {swipeDirection === "left" && (
                <ChevronLeft className="w-6 h-6 text-cooking-600" />
              )}
              {swipeDirection === "right" && (
                <ChevronRight className="w-6 h-6 text-cooking-600" />
              )}
              {swipeDirection === "up" && (
                <ChevronLeft className="w-6 h-6 text-cooking-600 rotate-90" />
              )}
              {swipeDirection === "down" && (
                <ChevronRight className="w-6 h-6 text-cooking-600 rotate-90" />
              )}
            </div>
          </div>
        )}
