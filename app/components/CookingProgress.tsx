...
export default function CookingProgress({
  ...
  // ⚡ Bolt: Derive a Set for O(1) membership lookups to prevent O(N*M) complexity
  // inside the steps.map() render loop below. Reduces membership check overhead for large recipes.
