...
export default function CookingProgress({ 
  ...
  // Memoize the completedSteps array into a Set.
  // This converts O(N*M) search operations in the render loop into O(N+M) complexity,
  // significantly reducing overhead when checking if a step is completed via .has() instead of .includes().
