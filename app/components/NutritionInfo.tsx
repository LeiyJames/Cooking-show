  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-cooking-50 to-warm-50 dark:from-cooking-900/20 dark:to-warm-900/20 rounded-xl p-4 mb-6">
        ...
        <div
          className={`text-3xl font-bold text-center ${getCalorieColor(nutritionPerServing.calories)}`}
        >
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="text-center">
          ...
          <div
            className={`text-lg font-bold ${getNutrientColor("protein", nutritionPerServing.protein)}`}
          >
        ...
        <div className="text-center">
          ...
          <div
            className={`text-lg font-bold ${getNutrientColor("fiber", nutritionPerServing.fiber)}`}
          >
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          ...
          <span
            className={`text-sm font-medium ${getNutrientColor("sugar", nutritionPerServing.sugar)}`}
          >
        ...
        <div className="flex justify-between items-center">
          ...
          <span
            className={`text-sm font-medium ${getNutrientColor("sodium", nutritionPerServing.sodium)}`}
          >
      ...
      <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        <p className="text-xs text-blue-800 dark:text-blue-200">
          💡 <strong>Tip:</strong> This recipe provides a good balance of
          nutrients.
