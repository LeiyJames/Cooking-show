...
export default function IngredientCalculator({
  ...
  // ⚡ Bolt Optimization: Use useMemo to compute derived state directly during render
  // This prevents the double-render cycle that happens when syncing state via useEffect
