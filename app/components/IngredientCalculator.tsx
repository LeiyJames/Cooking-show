      ...
      <div className="bg-gradient-to-r from-cooking-50 to-warm-50 dark:from-cooking-900/20 dark:to-warm-900/20 rounded-xl p-4 mb-6">
        <div className="flex items-center justify-between">
          <div className="text-center">
            ...
            <div className="flex items-center gap-3">
              <motion.button
                ...
                whileHover={{ scale: servings <= 1 ? 1 : 1.05 }}
                whileTap={{ scale: servings <= 1 ? 1 : 0.95 }}
                disabled={servings <= 1}
          ...
          <motion.button
            ...
            whileHover={{ scale: servings === originalServings ? 1 : 1.05 }}
            whileTap={{ scale: servings === originalServings ? 1 : 0.95 }}
            disabled={servings === originalServings}
            aria-label="Reset servings to original amount"
