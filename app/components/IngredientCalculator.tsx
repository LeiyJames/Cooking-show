    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="text-sm text-cooking-600 dark:text-cooking-400 hover:text-cooking-700 dark:hover:text-cooking-300 transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-cooking-500 rounded px-2 py-1"
      ...
      <div className="bg-gradient-to-r from-cooking-50 to-warm-50 dark:from-cooking-900/20 dark:to-warm-900/20 rounded-xl p-4 mb-6">
        <div className="flex items-center justify-between">
          <div className="text-center">
            ...
            >
              <motion.button
                ...
                className="p-2 bg-white dark:bg-gray-700 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-cooking-500"
              ...
              <motion.button
                onClick={() => adjustServings(1)}
                className="p-2 bg-white dark:bg-gray-700 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-cooking-500"
          ...
          <motion.button
            onClick={resetServings}
            className="p-2 bg-cooking-100 dark:bg-cooking-900/30 text-cooking-700 dark:text-cooking-300 rounded-lg hover:bg-cooking-200 dark:hover:bg-cooking-900/50 transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-cooking-500"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            aria-label="Reset servings to original"
