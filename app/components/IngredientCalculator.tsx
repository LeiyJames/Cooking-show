...
export default function IngredientCalculator({ ingredients, originalServings, dishName = 'recipe' }: IngredientCalculatorProps) {
  ...
  // Replaced useState and useEffect with useMemo for derived state.
  // This prevents an unnecessary double-render when adjusting servings
  // (once for servings state, again for scaledIngredients state).
