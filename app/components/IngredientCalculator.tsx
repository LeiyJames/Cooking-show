    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="text-sm text-cooking-600 dark:text-cooking-400 hover:text-cooking-700 dark:hover:text-cooking-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-300"
        >
          Reset
        </button>
      </div>
      ...
      <div className="bg-gradient-to-r from-cooking-50 to-warm-50 dark:from-cooking-900/20 dark:to-warm-900/20 rounded-xl p-4 mb-6">
        <div className="flex items-center justify-between">
          <div className="text-center">
            ...
            <div className="flex items-center gap-3">
              <motion.button
                ...
                className="p-2 bg-white dark:bg-gray-700 rounded-lg shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
          ...
          <motion.button
            ...
            disabled={servings === originalServings}
            className="p-2 bg-cooking-100 dark:bg-cooking-900/30 text-cooking-700 dark:text-cooking-300 rounded-lg hover:bg-cooking-200 dark:hover:bg-cooking-900/50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
