...
const filipinoDishes: Record<string, Dish> = {
  adobo: {
    ...
    defaultNotes:
      "Perfect for family gatherings and can be made ahead of time.",
  },
  sinigang: {
  ...
  "chicken-arroz-caldo": {
    ...
    defaultNotes:
      "A comforting rice porridge perfect for cold weather or when feeling under the weather.",
  },
  "ginisang-monggo": {
    ...
    defaultNotes:
      "A healthy and nutritious soup that's perfect for any day of the week.",
  },
  "pancit-palabok": {
  ...
  "chicken-inasal": {
    ...
    defaultNotes:
      "A famous grilled chicken dish from Bacolod, known for its tangy and savory flavor.",
  },
  "beef-mechado": {
    title: "Beef Mechado",
    emoji: "🥩",
  ...
  "chicken-afritada": {
    ...
    defaultNotes:
      "A classic Filipino chicken stew that's perfect for family meals.",
  },
  "beef-tapa": {
    title: "Beef Tapa",
    emoji: "🥩",
    ...
    defaultNotes:
      "A classic Filipino breakfast dish that's perfect for any time of day.",
  },
  "pancit-luglug": {
    title: "Pancit Luglug",
    emoji: "🍜",
  ...
  "chicken-pastel": {
    ...
    defaultNotes:
      "A rich and creamy chicken pie perfect for special occasions.",
  },
  "beef-estofado": {
    title: "Beef Estofado",
    emoji: "🥩",
    ...
    defaultNotes:
      "A sweet and savory beef stew that's perfect for family gatherings.",
  },
  "pancit-molo": {
    title: "Pancit Molo",
    emoji: "🥟",
  ...
  "chicken-relleno": {
    ...
    defaultNotes:
      "An elegant stuffed chicken dish perfect for special occasions.",
  },
  "beef-morcon": {
    title: "Beef Morcon",
    emoji: "🥩",
  ...
  "pancit-batil-patung": {
    ...
    defaultNotes:
      "A unique noodle dish from Tuguegarao featuring carabao meat.",
  },
};
...
export default function FilipinoDishPage() {
  ...
  // ⚡ Bolt: Memoized Set for O(1) membership lookups instead of O(N) array includes
  const completedStepsSet = React.useMemo(
